  ...
  7. __
  8. Buchungsregeln einrichten (Ab 2.9) 
...
Mit einem kleinen Codeschnipsel ( [ mehr dazu
](https://commonsbooking.org/docs/einstellungen/hooks-und-filter/) ) kannst du
eine Rolle definieren, die grundsätzlich nicht von Buchungsregeln betroffen
ist. Dafür musst du die Rolle nicht manuell bei jeder Regel hinzufügen.
...
manueller Vergabe von Berechtigungen.

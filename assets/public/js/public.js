...
!function(t, e) {
    ...
    return function(t) {
        ...
        var d = i(5), c = i(1), h = l(i(0)), p = i(2), u = i(0), m = function(t) {
            function e(e) {
        ...
        var a = i(1), r = s(i(0)), l = i(2), d = function() {
            function t() {
                this.options = {
                    element: null,
                    elementEnd: null,
            ...
            return t.prototype.render = function() {
                ...
                2 === this.datePicked.length && t.isBetween(this.datePicked[0], this.datePicked[1]) && i.classList.add(r.isInRange); else if (this.options.startDate) {
                    ...
                    this.options.disallowLockDaysInRange || console.log(i));
                }
                    ...
                    if (this.options.countLockedDays && this.options.countLockedDaysMax > 0) {
                        ...
                        for (;h > 0; ) {
                            ...
                            for (var D = 0, v = u; D < v.length; D++) {
                                v[D].getTime() === c.getTime() && (this.dateIsBooked(c, this.options.bookedDaysInclusivity) || this.dateIsPartiallyBooked(c, this.options.partiallyBookedDaysInclusivity) || (p <= 0 ? (d += 1, 
                                h += 1) : p > 0 && (p -= 1)));
                            }
                        }
                    }
                    l = this.datePicked[0].clone().add(this.options.maxDays + d + n, "day");
                    t.isSameOrBefore(s) && i.classList.add(r.isLocked), t.isSameOrAfter(l) && i.classList.add(r.isLocked);
                }

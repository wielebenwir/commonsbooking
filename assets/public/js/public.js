!function(t, e) {
    ...
    return function(t) {
            ...
            return t.parseDateTime = function(e, i, o) {
                ...
                if ("string" == typeof e) {
                    ...
                    if (n.length) {
                        ...
                        for (var a = 0, l = Object.entries(n); a < l.length; a++) {
                            var p = l[a], c = p[0], h = p[1], d = Number(c), u = t.formatPatterns(h[0], o), m = u.group, f = u.pattern;
                            r[m] = d + 1, r.value += f, r.value += ".*?";
                        }
                        var g = new RegExp("^" + r.value + "$");
                        if (g.test(e)) {
                            var y = g.exec(e), k = Number(y[r.year]), v = null;
                ...
                if (n.length) {
                    ...
                    for (var r = 0, a = Object.entries(n); r < a.length; r++) {
                        var l = a[r], p = l[0], c = l[1], h = Number(p);
        ...
        var a = i(5), l = i(0), p = r(i(1)), c = i(2), h = function(t) {
            function e(e) {
                ...
                var o = s(s({}, i.options.dropdowns), e.dropdowns), n = s(s({}, i.options.buttonText), e.buttonText), r = s(s({}, i.options.tooltipText), e.tooltipText);
                i.options = s(s({}, i.options), e), i.options.dropdowns = s({}, o), i.options.buttonText = s({}, n), 
                i.options.tooltipText = s({}, r), i.options.elementEnd || (i.options.allowRepick = !1), 
                ...
                var a = i.parseInput(), p = a[0], c = a[1];
                i.options.startDate && (i.options.singleMode || i.options.endDate) && (p = new l.DateTime(i.options.startDate, i.options.format, i.options.lang)), 
                p && i.options.endDate && (c = new l.DateTime(i.options.endDate, i.options.format, i.options.lang)), 
                p instanceof l.DateTime && !isNaN(p.getTime()) && (i.options.startDate = p), i.options.startDate && c instanceof l.DateTime && !isNaN(c.getTime()) && (i.options.endDate = c), 
            ...
            return n(e, t), e.prototype.onInit = function() {
                ...
                })), this.options.inlineMode && (this.show(), this.options.mobileFriendly && c.isMobile() && (window.dispatchEvent(new Event("orientationchange")), 
                ...
                if (i && this.picker) if (this.shouldShown(i)) this.show(i); else if (i.closest("." + p.litepicker)) {
                    if (i.classList.contains(p.dayItem)) {
                        ...
                        if (this.shouldCheckBookedDays()) {
                            ...
                            }).length, a = this.options.anyBookedDaysAsCheckout && 1 === this.datePicked.length;
                    ...
                    if (i.classList.contains(p.buttonNextMonth)) {
                        ...
                        this.options.splitView && (u = i.closest("." + p.monthItem), h = c.findNestedMonthItem(u), 
                ...
                var o = this.picker.getBoundingClientRect(), n = i.getBoundingClientRect(), s = t.getBoundingClientRect(), r = s.top, a = s.left;
                if (this.options.inlineMode && this.options.parentEl) {
                    var l = this.picker.parentNode.getBoundingClientRect();
                    r -= l.top, a -= l.left;
                } else r -= o.top, a -= o.left;
                r -= n.height, a -= n.width / 2, a += s.width / 2, i.style.top = r + "px", i.style.left = a + "px", 
                ...
                var e = this, i = t.target;
                if (this.isDayItem(i) && ("function" == typeof this.options.onDayHover && this.options.onDayHover.call(this, l.DateTime.parseDateTime(i.dataset.time), i.classList.toString().split(/\s/), i), 
                this.shouldAllowMouseEnter(i))) {
                    ...
                    var o = this.picker.querySelector("." + p.dayItem + '[data-time="' + this.datePicked[0].getTime() + '"]'), n = this.datePicked[0].clone(), s = new l.DateTime(i.dataset.time), r = !1;
                    ...
                    }), i.classList.add(p.isEndDate), r ? (o && o.classList.add(p.isFlipped), i.classList.add(p.isFlipped)) : (o && o.classList.remove(p.isFlipped), 
                    i.classList.remove(p.isFlipped)), this.options.showTooltip) {
                        var c = s.diff(n, "day");
                        if (this.options.hotelMode || (c += 1), c > 0) {
                            var h = this.pluralSelector(c), d = c + " " + (this.options.tooltipText[h] ? this.options.tooltipText[h] : "[" + h + "]");
                ...
                if (this.options.elementEnd ? i instanceof l.DateTime && o instanceof l.DateTime && i.format(n) === this.options.element.value && o.format(n) === this.options.elementEnd.value : this.options.singleMode ? i instanceof l.DateTime && i.format(n) === this.options.element.value : i instanceof l.DateTime && o instanceof l.DateTime && "" + i.format(n) + this.options.delimiter + o.format(n) === this.options.element.value) {
                    ...
                    var r = i.clone(), a = 0;
                    (this.options.elementEnd ? i.format(n) === t.target.value : t.target.value.startsWith(i.format(n))) || (r = o.clone(), 
                    a = this.options.numberOfMonths - 1), "function" == typeof this.options.onSelect && this.options.onSelect.call(this, this.getStartDate(), this.getEndDate()), 
                    this.gotoDate(r, a);
                }
        ...
        var n = i(0), s = o(i(1)), r = i(2), a = function() {
            function t() {
                this.options = {
                    element: null,
                    elementEnd: null,
            ...
            return t.prototype.render = function() {
                ...
                for (var o = this.calendars[0].clone(), n = o.getMonth(), r = o.getMonth() + this.options.numberOfMonths, a = 0, l = n; l < r; l += 1) {
                    var p = o.clone();
                    p.setDate(1), this.options.splitView ? p = this.calendars[a].clone() : p.setMonth(l), 
                    i.appendChild(this.renderMonth(p)), a += 1;
                }
                if (this.picker.innerHTML = "", e.appendChild(i), this.options.useResetBtn) {
                    var c = document.createElement("a");
                    c.href = "#", c.className = s.resetButton, c.innerHTML = this.options.buttonText.reset, 
                ...
                var e = this, i = t.clone(), o = 32 - new Date(i.getFullYear(), i.getMonth(), 32).getDate(), a = document.createElement("div");
                ...
                if (this.options.dropdowns.months) {
                    ...
                    for (var h = 0; h < 12; h += 1) {
                        ...
                        d.selected = u.getMonth() === t.getMonth(), c.appendChild(d);
                    }
                ...
                if (this.options.dropdowns.years) {
                    ...
                    if (t.getFullYear() < g && ((d = document.createElement("option")).value = String(t.getFullYear()), 
                    d.text = String(t.getFullYear()), d.selected = !0, d.disabled = !0, f.appendChild(d)), 
                ...
                w.href = "#", w.className = s.buttonNextMonth, w.innerHTML = this.options.buttonText.nextMonth, 
                l.appendChild(b), l.appendChild(p), l.appendChild(w), this.options.minDate && i.isSameOrBefore(new n.DateTime(this.options.minDate), "month") && a.classList.add(s.noPreviousMonth), 
                ...
                for (E = 1; E <= o; E += 1) i.setDate(E), this.options.showWeekNumbers && i.getDay() === this.options.firstDay && L.appendChild(this.renderWeekNumber(i)), 
                ...
                this.options.minDays && 1 === this.datePicked.length) {
                    var o = Number(!this.options.hotelMode), r = this.datePicked[0].clone().subtract(this.options.minDays - o, "day"), a = this.datePicked[0].clone().add(this.options.minDays - o, "day");
                ...
                r = this.datePicked[0].clone().subtract(this.options.maxDays + o, "day"), a = this.datePicked[0].clone().add(this.options.maxDays + o, "day"), 
                ...
                this.options.lockDays.length && this.options.lockDays.filter(function(i) {
                    ...
                    var c = this.dateIsBooked(t, l), h = this.dateIsBooked(p, "[]"), d = this.dateIsBooked(t, "(]"), u = 0 === this.datePicked.length && c || 1 === this.datePicked.length && h && c || 1 === this.datePicked.length && h && d, m = this.options.anyBookedDaysAsCheckout && 1 === this.datePicked.length;
        ...
        t.exports = function(t) {
            ...
            return e.toString = function() {
                return this.map(function(e) {
                    var i = function(t, e) {
                        var r, a, l, i = t[1] || "", o = t[3];
                        if (!o) return i;
                        if (e && "function" == typeof btoa) {
                            var n = (r = o, a = btoa(unescape(encodeURIComponent(JSON.stringify(r)))), l = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a), 
                ...
                for (var r = 0; r < t.length; r++) {
                    var a = t[r];
                    null != a[0] && o[a[0]] || (i && !a[2] ? a[2] = i : i && (a[2] = "(".concat(a[2], ") and (").concat(i, ")")), 
                    e.push(a));
                }
            }, e;
        };
        ...
        function a(t, e) {
            for (var i = [], o = {}, n = 0; n < t.length; n++) {
                var s = t[n], r = e.base ? s[0] + e.base : s[0], a = {
                    css: s[1],
                    media: s[2],
                    sourceMap: s[3]
                };
        ...
        r.Litepicker.prototype.show = function(t) {
            ...
            if (this.options.mobileFriendly && l.isMobile()) {
                ...
                document.body.classList.add(a.litepickerOpen), "function" == typeof this.options.onShow && this.options.onShow.call(this), 
            ...
            var s = e.getBoundingClientRect(), r = this.picker.getBoundingClientRect(), p = s.bottom, c = s.left, h = 0, d = 0, u = 0, m = 0;
            if (this.options.parentEl) {
                var f = this.picker.parentNode.getBoundingClientRect();
                p -= f.bottom, (p += s.height) + r.height > window.innerHeight && s.top - f.top - s.height > 0 && (u = s.top - f.top - s.height), 
            ...
            this.picker.style.top = (u || p) + d + "px", this.picker.style.left = (m || c) + h + "px", 
            ...
            "function" == typeof this.options.onHide && this.options.onHide.call(this), this.options.mobileFriendly && (document.body.classList.remove(a.litepickerOpen), 

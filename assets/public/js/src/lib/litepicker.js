    ...
    return (function () {
        var t = {
                ...
                379: function (t, e, i) {
                    ...
                    function r(t, e) {
                        for (var i = {}, o = [], n = 0; n < t.length; n++) {
                            ...
                            (-1 !== h
                                ? (s[h].references++, s[h].updater(p))
                                : s.push({ identifier: c, updater: y(p, e), references: 1 }),
                                o.push(c));
                        }
                        return o;
                    }
                ...
                722: function (t, e, i) {
                    ...
                    (Object.defineProperty(e, '__esModule', { value: !0 }), (e.Calendar = void 0));
                    var a = i(939),
                        r = s(i(110)),
                        l = i(593),
                        d = (function () {
                            ...
                            return (
                                (t.prototype.render = function () {
                                    ...
                                    ((i.className = r.containerMonths),
                                        r['columns' + this.options.numberOfColumns] &&
                                            (i.classList.remove(r.columns2, r.columns3, r.columns4),
                                            i.classList.add(
                                                r['columns' + this.options.numberOfColumns],
                                            )),
                                        this.options.splitView && i.classList.add(r.splitView),
                                        this.options.showWeekNumbers &&
                                            i.classList.add(r.showWeekNumbers));
                                    for (
                                        ...
                                        (d.setDate(1),
                                            this.options.splitView
                                                ? (d = this.calendars[a].clone())
                                                : d.setMonth(l),
                                            i.appendChild(this.renderMonth(d)),
                                            (a += 1));
                                    }
                                    if (
                                        ...
                                        ((c.href = '#'),
                                            (c.className = r.resetButton),
                                            (c.innerHTML = this.options.buttonText.reset),
                                            c.addEventListener('click', function (e) {
                                                (e.preventDefault(),
                                                    t.clearSelection(),
                                                    'function' ==
                                                        typeof t.options.resetBtnCallback &&
                                                        t.options.resetBtnCallback.call(t));
                                            }),
                                            e
                                                .querySelector('.' + r.monthItem + ':last-child')
                                                .querySelector('.' + r.monthItemHeader)
                                                .appendChild(c));
                                    }
                                    if (
                                ...
                                (t.prototype.renderMonth = function (t) {
                                    var e = this,
                                        ...
                                        o =
                                            32 -
                                            new Date(i.getFullYear(), i.getMonth(), 32).getDate(),
                                    ...
                                    if (this.options.dropdowns.months) {
                                        ...
                                        for (var h = 0; h < 12; h += 1) {
                                            var p = document.createElement('option'),
                                                u = new a.DateTime(
                                                    new Date(t.getFullYear(), h, 1, 0, 0, 0),
                                                );
                                            ((p.value = String(h)),
                                                (p.text = u.toLocaleString(this.options.lang, {
                                                    month: 'long',
                                                })),
                                                (p.disabled =
                                                    (this.options.minDate &&
                                                        u.isBefore(
                                                            new a.DateTime(this.options.minDate),
                                                            'month',
                                                        )) ||
                                                    (this.options.maxDate &&
                                                        u.isAfter(
                                                            new a.DateTime(this.options.maxDate),
                                                            'month',
                                                        ))),
                                                (p.selected = u.getMonth() === t.getMonth()),
                                                c.appendChild(p));
                                        }
                                    ...
                                    if (this.options.dropdowns.years) {
                                        ...
                                        var f = this.options.dropdowns.minYear,
                                            g = this.options.dropdowns.maxYear
                                        ...
                                        ((v.className = r.monthItemYear),
                                            (v.innerHTML = String(t.getFullYear())),
                                            d.appendChild(v));
                                    }
                                    var b = document.createElement('a');
                                    ((b.href = '#'),
                                        (b.className = r.buttonPreviousMonth),
                                        (b.innerHTML = this.options.buttonText.previousMonth));
                                    var w = document.createElement('a');
                                    ((w.href = '#'),
                                        (w.className = r.buttonNextMonth),
                                        ...
                                        this.options.minDate &&
                                            ...
                                            n.classList.add(r.noPreviousMonth),
                                        this.options.maxDate &&
                                            i.isSameOrAfter(
                                                new a.DateTime(this.options.maxDate),
                                                'month',
                                            ) &&
                                            n.classList.add(r.noNextMonth));
                                    var M = document.createElement('div');
                                    ((M.className = r.monthItemWeekdaysRow),
                                        this.options.showWeekNumbers &&
                                            (M.innerHTML = '<div>W</div>'));
                                    for (var x = 1; x <= 7; x += 1) {
                                        var T = 3 + this.options.firstDay + x,
                                            B = document.createElement('div');
                                        ((B.innerHTML = this.weekdayName(T)),
                                            (B.title = this.weekdayName(T, 'long')),
                                            M.appendChild(B));
                                    }
                                    ...
                                    this.options.showWeekNumbers &&
                                        L &&
                                        _.appendChild(this.renderWeekNumber(i));
                                    for (var I = 0; I < L; I += 1) {
                                ...
                                (t.prototype.renderDay = function (t) {
                                    ...
                                    if (
                                        ...
                                        (2 === this.datePicked.length &&
                                            ...
                                            2 === this.datePicked.length &&
                                                ...
                                                i.classList.add(r.isInRange));
                                    else if (this.options.startDate) {
                                        var o =
                                            document.getElementsByClassName('is-end-date').length >
                                            0;
                                    ...
                                    if (
                                        (this.options.minDate &&
                                            t.isBefore(new a.DateTime(this.options.minDate)) &&
                                            i.classList.add(r.isLocked),
                                        this.options.maxDate &&
                                            t.isAfter(new a.DateTime(this.options.maxDate)) &&
                                            i.classList.add(r.isLocked),
                                        ...
                                        (t.isBetween(s, this.datePicked[0], '(]') &&
                                            i.classList.add(r.isLocked),
                                            t.isBetween(this.datePicked[0], l, '[)') &&
                                                i.classList.add(r.isLocked));
                                    }
                                    if (this.options.maxDays && 1 === this.datePicked.length) {
                                        ...
                                        if (
                                            ...
                                            (this.options.countLockedDaysMax > 0 ||
                                                !this.options.countLockedDays)
                                        ) {
                                            for (
                                                var c = this.datePicked[0].clone(),
                                                    h = this.options.maxDays,
                                                    p = this.options.countLockedDaysMax,
                                                    u = [],
                                                    m = 0,
                                                    y = [
                                                ...
                                                for (var f = 0, g = y[m]; f < g.length; f++) {
                                                    var k = g[f];
                                                ...
                                                for (var D = 0, v = u; D < v.length; D++)
                                                    v[D].getTime() === c.getTime() &&
                                                        (this.dateIsBooked(
                                                            ...
                                                            (p <= 0 || !this.options.countLockedDays
                                                                ? ((d += 1), (h += 1))
                                                                : p > 0 && (p -= 1)));
                                            }
                                        }
                                        ((l = this.datePicked[0]
                                            .clone()
                                            .add(this.options.maxDays + d + n, 'day')),
                                    ...
                                    if (
                                        ...
                                        this.options.bookedDays.length &&
                                            (M = this.options.bookedDays.filter(function (i) {
                                                return i instanceof Array
                                                    ? t.isBetween(
                                                          i[0],
                                                          i[1],
                                            ...
                                            (i.classList.add(r.isBooked),
                                            this.datePicked.length > 0 &&
                                                !this.bookedDayAfterSelection &&
                                                this.datePicked[0].getTime() < t.getTime() &&
                                                (this.bookedDayAfterSelection = t.getTime())),
                                        this.options.partiallyBookedDays.length &&
                                            (I = this.options.partiallyBookedDays.filter(
                                                function (i) {
                                                    return i instanceof Array
                                                        ? t.isBetween(
                                                              i[0],
                                            ...
                                            (!1 ===
                                                (L =
                                                    this.options.days[
                                                        t.format(this.options.format)
                                                    ]).firstSlotBooked &&
                                                i.classList.add(r.isPartiallyBookedStart),
                                            !1 === L.lastSlotBooked &&
                                                i.classList.add(r.isPartiallyBookedEnd)),
                                        this.options.holidays.length &&
                                            this.options.holidays.filter(function (i) {
                                                return i instanceof Array
                                                    ? t.isBetween(
                                                          i[0],
                                                          i[1],
                                                          e.options.holidaysInclusivity,
                                                      )
                                                    : i.isSame(t, 'day');
                                            }).length &&
                                            i.classList.add(r.isHoliday),
                                        this.options.highlightedDays.length &&
                                            ...
                                            i.classList.add(r.isHighlighted),
                                        ...
                                        if (
                                            ...
                                            this.options.hotelMode &&
                                                1 === this.datePicked.length &&
                                                (w = '()');
                                            var M = this.dateIsBooked(t, w),
                                                x = this.dateIsBooked(b, '[]'),
                                                T = this.dateIsBooked(t, '(]'),
                                                B =
                                                    (0 === this.datePicked.length && M) ||
                                                    (1 === this.datePicked.length && x && M) ||
                                                    (1 === this.datePicked.length && x && T),
                                                _ =
                                        ...
                                        if (this.options.partiallyBookedDays.length) {
                                            ((w = this.options.partiallyBookedDaysInclusivity),
                                                this.options.hotelMode &&
                                                    ...
                                                    (w = '()'));
                                            var L,
                                                I = this.dateIsPartiallyBooked(t, w),
                                                P =
                                                    ((x = this.dateIsPartiallyBooked(b, '[]')),
                                                    (T = this.dateIsPartiallyBooked(t, '(]')),
                                                    (0 === this.datePicked.length && I) ||
                                                        (1 === this.datePicked.length && x && I) ||
                                                        (1 === this.datePicked.length && x && T)),
                                                S =
                                                    this.options.anyPartiallyBookedDaysAsCheckout &&
                                                    1 === this.datePicked.length;
                                            P &&
                                                !S &&
                                                (!1 ===
                                ...
                                (t.prototype.renderFooter = function () {
                                    ...
                                    if (
                                        ...
                                        t.querySelector('.' + r.previewDateRange).innerHTML =
                ...
                939: function (t, e) {
                    'use strict';
                    (Object.defineProperty(e, '__esModule', { value: !0 }), (e.DateTime = void 0));
                    var i = (function () {
                        function t(e, i, o) {
                            (void 0 === e && (e = null),
                                void 0 === i && (i = null),
                                    ...
                                    if (n.length) {
                                        ...
                                        if (f.test(e)) {
                                            var g = f.exec(e),
                                                ...
                                                D = null;
                                            a.month
                                                ? (D = Number(g[a.month]) - 1)
                                                : a.shortMonth
                                                  ? (D = t.shortMonths(o).indexOf(g[a.shortMonth]))
                                                  : a.longMonth &&
                                                    (D = t.longMonths(o).indexOf(g[a.longMonth]));
                                ...
                                if (n.length) {
                                    ...
                                    for (var a = 0, r = Object.entries(n); a < r.length; a++) {
                                        ...
                                        ((o += this.formatTokens(c[0], i)),
                                            ...
                                            h === n.length - 1 &&
                                                (o += e.substring(c.index + c[0].length)));
                                    }
                                }
                                return o.replace(/\\/g, '');
                            }),
                            ...
                            function e(e) {
                                ...
                                ((i.options = s(s({}, i.options), e)),
                                    ...
                                    i.options.lockDays.length &&
                                        (i.options.lockDays = c.DateTime.convertArray(
                                            i.options.lockDays,
                                            i.options.lockDaysFormat,
                                        )),
                                    i.options.holidays.length &&
                                        (i.options.holidays = c.DateTime.convertArray(
                                            i.options.holidays,
                                            i.options.holidaysFormat,
                                        )),
                                    i.options.bookedDays.length &&
                                        (i.options.bookedDays = c.DateTime.convertArray(
                                            i.options.bookedDays,
                                            i.options.bookedDaysFormat,
                                        )),
                                    i.options.partiallyBookedDays.length &&
                                        (i.options.partiallyBookedDays = c.DateTime.convertArray(
                                            i.options.partiallyBookedDays,
                                            i.options.partiallyBookedDaysFormat,
                                        )),
                                    i.options.highlightedDays.length &&
                                        (i.options.highlightedDays = c.DateTime.convertArray(
                                    ...
                                    i.options.hotelMode &&
                                        !('partiallyBookedDaysInclusivity' in e) &&
                                        (i.options.partiallyBookedDaysInclusivity = '[)'),
                                    i.options.hotelMode &&
                                ...
                                (i.options.startDate &&
                                    ...
                                    l instanceof c.DateTime &&
                                        !isNaN(l.getTime()) &&
                                        (i.options.startDate = l),
                                    i.options.startDate &&
                                        d instanceof c.DateTime &&
                                        !isNaN(d.getTime()) &&
                                        (i.options.endDate = d),
                                    !i.options.singleMode ||
                                        i.options.startDate instanceof c.DateTime ||
                                        (i.options.startDate = null),
                                    i.options.singleMode ||
                                        (i.options.startDate instanceof c.DateTime &&
                                            i.options.endDate instanceof c.DateTime) ||
                                        ((i.options.startDate = new c.DateTime(
                                            i.options.startDate,
                                            i.options.format,
                                            i.options.lang,
                                        )),
                            ...
                            return (
                                                ...
                                                function (e) {
                                                    var i = function () {
                                                        if (
                                                            p.isMobile() &&
                                                            t.isShowning() &&
                                                            ('landscape' === p.getOrientation()
                                                                ? ((t.options.numberOfMonths = 2),
                                                                  (t.options.numberOfColumns = 2))
                                                                : ((t.options.numberOfMonths =
                                                                      t.options.mobileCalendarMonthCount),
                                                                  (t.options.numberOfColumns = 1)),
                                                            t.render(),
                                                            !t.options.inlineMode)
                                                        ) {
                                                            var e =
                                                                t.picker.getBoundingClientRect();
                                                            ((t.picker.style.top =
                                                                'calc(50% - ' +
                                                                e.height / 2 +
                                                                'px)'),
                                ...
                                (e.prototype.parseInput = function () {
                                    ...
                                    if (this.options.elementEnd) {
                                        ...
                                        return [
                                            new c.DateTime(o, this.options.format),
                                            new c.DateTime(n, this.options.format),
                                        ];
                                    }
                                    return [];
                                }),
                                ...
                                (e.prototype.shouldCheckPartiallyBookedDays = function () {
                                    return (
                                        this.options.disallowPartiallyBookedDaysInRange &&
                                        this.options.partiallyBookedDays.length &&
                                        2 === this.datePicked.length
                                    );
                                }),
                                (e.prototype.shouldCheckHolidays = function () {
                                    return (
                                        this.options.disallowHolidaysInRange &&
                                        this.options.holidays.length &&
                                        2 === this.datePicked.length
                                    );
                                }),
                                    ...
                                    if (i && this.picker)
                                        if (this.shouldShown(i)) this.show(i);
                                            ...
                                            if (this.shouldCheckPartiallyBookedDays()) {
                                                ...
                                                if (
                                                    !(m = this.options.partiallyBookedDays.filter(
                                                        function (t) {
                                                            return t instanceof Array
                                                                ? t[0].isBetween(
                                                                      e.datePicked[0],
                                                    ...
                                                    this.datePicked[0].getDate() !==
                                                        this.datePicked[1].getDate()
                                                ) {
                                                    var r = this.datePicked[0].format(
                                                            this.options.bookedDaysFormat,
                                                        ),
                                                        l = this.datePicked[1].format(
                                                            this.options.bookedDaysFormat,
                                                        ),
                                                        d = this.options.days[r];
                                                    m =
                                                        this.options.days[l].firstSlotBooked ||
                                                        d.lastSlotBooked;
                                                }
                                                var u =
                                                    this.options.anyBookedDaysAsCheckout &&
                                            ...
                                            if (this.shouldCheckBookedDays()) {
                                                var m,
                                                    y = this.options.bookedDaysInclusivity;
                                            ...
                                            if (
                                                ('function' == typeof this.options.onDaySelect &&
                                                    this.options.onDaySelect.call(
                                                        this,
                                                        c.DateTime.parseDateTime(i.dataset.time),
                                                        this.datePicked.length,
                                                    ),
                                                this.render(),
                                                ...
                                                (this.options.singleMode && this.datePicked.length
                                                    ...
                                                    : this.options.singleMode ||
                                                      ...
                                                      this.hide(),
                                                      (f = !0)),
                                                    'function' == typeof this.options.onAutoApply &&
                                                        this.options.onAutoApply.call(this, f));
                                            }
                                        } else {
                                            if (i.classList.contains(h.buttonPreviousMonth)) {
                                                if ((t.preventDefault(), !this.isSamePicker(i)))
                                                    return;
                                                var g = 0,
                                                    k = this.options.moveByOneMonth
                                                        ? 1
                                                ...
                                                return (
                                                    this.calendars[g].setMonth(
                                                        this.calendars[g].getMonth() - k,
                                                    ),
                                                    this.gotoDate(this.calendars[g], g),
                                                    void (
                                                        'function' ==
                                                            typeof this.options.onChangeMonth &&
                                                        this.options.onChangeMonth.call(
                                                            this,
                                                            this.calendars[g],
                                                            g,
                                ...
                                (e.prototype.shouldAllowMouseEnter = function (t) {
                                    return !(
                                        ...
                                        t.classList.contains(h.isHoliday) ||
                                ...
                                (e.prototype.onMouseEnter = function (t) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            return;
                                        var o = this.picker.querySelector(
                                                '.' +
                                                    h.dayItem +
                                                    '[data-time="' +
                                            ...
                                            s = new c.DateTime(i.dataset.time),
                                            a = !1;
                                        ...
                                        if (
                                            (Array.prototype.slice
                                                ...
                                                .forEach(function (t) {
                                                    var i = new c.DateTime(t.dataset.time),
                                                        o = e.renderDay(i);
                                                    if (i.isBetween(n, s)) {
                                                        var a =
                                                            e.options.days[
                                                                i.format(e.options.bookedDaysFormat)
                                                            ];
                                                        (a.bookedDay
                                                            ? o.classList.add(h.isBooked)
                                                            : !a.partiallyBookedDay ||
                                                              a.holiday ||
                                                              a.locked ||
                                                              (a.firstSlotBooked &&
                                                                  o.classList.add(
                                                                      h.isPartiallyBookedStart,
                                                                  ),
                                                              a.lastSlotBooked &&
                                                                  o.classList.add(
                                                                      h.isPartiallyBookedEnd,
                                                                  )),
                                                            e.options.disallowLockDaysInRange ||
                                                                (a.holiday
                                                                    ? o.classList.remove(
                                                                          h.isHoliday,
                                                                      )
                                ...
                                (e.prototype.onInput = function (t) {
                                    ...
                                    if (
                                        this.options.elementEnd
                                            ? i instanceof c.DateTime &&
                                              o instanceof c.DateTime &&
                                        ...
                                        var a = i.clone(),
                                            r = 0;
                                        ((this.options.elementEnd
                                            ? i.format(n) === t.target.value
                                            : t.target.value.startsWith(i.format(n))) ||
                                            ((a = o.clone()),
                                            (r = this.options.numberOfMonths - 1)),
                    ...
                    ((l.Litepicker.prototype.show = function (t) {
                        ...
                        if (this.options.mobileFriendly && c.isMobile()) {
                            ...
                            return (
                                ...
                                document.body.classList.add(d.litepickerOpen),
                        ...
                        if (this.options.parentEl) {
                            ...
                            ((s -= u.bottom),
                                (s += o.height) + n.height > window.innerHeight &&
                                    o.top - u.top - o.height > 0 &&
                                    (h = o.top - u.top - o.height),
                                (a -= u.left) + n.width > window.innerWidth &&
                                    o.right - u.right - n.width > 0 &&
                                    (p = o.right - u.right - n.width));
                        } else
                            ((r = window.scrollX || window.pageXOffset),
                                ...
                                a + n.width > window.innerWidth &&
                                    o.right - n.width > 0 &&
                                    (p = o.right - n.width));
                        ((this.picker.style.top = (h || s) + l + 'px'),
                            (this.picker.style.left = (p || a) + r + 'px'),
                            (this.picker.style.right = null),
                            (this.picker.style.bottom = null),
                            'function' == typeof this.options.onShow &&
                                this.options.onShow.call(this));
                            ...
                            this.isShowning() &&
                                ...
                                this.options.inlineMode
                                    ...
                                    : ((this.picker.style.display = 'none'),
                                      ...
                                      this.options.mobileFriendly &&
                                          (document.body.classList.remove(d.litepickerOpen),
                        ...
                        (l.Litepicker.prototype.setHolidays = function (t) {
                            ((this.options.holidays = r.DateTime.convertArray(
                                t,
                        ...
                        (l.Litepicker.prototype.setPartiallyBookedDays = function (t) {
                            ((this.options.partiallyBookedDays = r.DateTime.convertArray(
                                t,
                        ...
                        (l.Litepicker.prototype.setBookedDays = function (t) {
                            ((this.options.bookedDays = r.DateTime.convertArray(
                                t,
                                this.options.bookedDaysFormat,
                            )),
                                this.render());
                        ...
                        (l.Litepicker.prototype.setOptions = function (t) {
                            ...
                            ((this.options = o(o({}, this.options), t)),
                                ...
                                !this.options.singleMode ||
                                    this.options.startDate instanceof r.DateTime ||
                                    ((this.options.startDate = null),
                                    (this.options.endDate = null)),
                                this.options.singleMode ||
                                    (this.options.startDate instanceof r.DateTime &&
                                        this.options.endDate instanceof r.DateTime) ||
                                    ((this.options.startDate = new r.DateTime(
                                        this.options.startDate,
                                        this.options.format,
                                        this.options.lang,
        ...
        return (
            (function () {
                ...
                (Object.defineProperty(t, 'Litepicker', {
                    ...
                    i(997),
                    i(362),
                    (window.Litepicker = e.Litepicker),
                    e.Litepicker);
            })(),
            o.Litepicker
        );

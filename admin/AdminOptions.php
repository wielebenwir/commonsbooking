...
function commonsbooking_register_main_options_metabox() {
    ...
    $group_main1 = $main_options->add_field( array(
        'id'      => 'group_main_options',
        'type'    => 'group',
        'options' => array (
     ...
     * field example
     */
    $main_options->add_group_field( $group_main1, array(
	...
	$args = array(
		...
		'menu_title'   => 'E-Mail', // Use menu title, & not title to hide main h2.
		'object_types' => array( 'options-page' ),
		'option_key'   => 'commonsbooking_email_options',
    ...
    $group_email = $email_options->add_field( array(
        'id'      => 'email_options_general',
        'type'    => 'group',
        'options' => array (
     ...
     * e-mail sender name
     */
    $email_options->add_group_field( $group_email, array(

...
class Location extends View
{
    ...
    {
        $jsonResponse = \CommonsBooking\View\Calendar::getCalendarDataArray();
    ...
    public static function getTemplateData(\WP_Post $post = null)
    {
        ...
        $args = [
            ...
            'calendar_data' => json_encode(\CommonsBooking\View\Calendar::getCalendarDataArray($item ?: null, $location))
        ];

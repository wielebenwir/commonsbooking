			...
			echo '
				...
				add_query_arg(
					array(
						...
						'redir' => rawurlencode( add_query_arg( array() ) ),
					)
				)
			) . '" >
		...
		try {
            ...
            <div class="cmb-row cmb2-id-booking-codes-info">
                ...
                <div id="booking-codes-download" class="cmb-td">' . ( $timeframe->hasBookingCodes() ? '
                    <a id="booking-codes-download-link" href="' . esc_url( add_query_arg( array( 'action' => 'cb_download-bookingscodes-csv' ) ) ) . '" target="_blank"><strong>Download booking codes</strong></a>

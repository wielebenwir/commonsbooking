...
class BookablePost extends CustomPost {
	 ...
	 * @param int[]       $locations - If called from Item, this array should contain the location IDs to filter the timeframes
	 * @param int[]       $items - If called from Location, this array should contain the item IDs to filter the timeframes

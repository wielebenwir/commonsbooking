...
class Timeframe extends CustomPost {
	...
	*/
	...
	/**
	 * Returns whether or booking codes are created
	 *
	 * @return boolean
	 */
	public function createBookingCodes() {
		return $this->getMeta( 'create-booking-codes', true ) === 'on';
	}
}

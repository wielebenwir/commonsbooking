...
class Day {
	 ...
	 */
	public function __construct( string $date, array $locations = array(), array $items = array(), array $types = array(), array $possibleTimeframes = array() ) {
		$this->date      = $date;
	...
	public function getRestrictions(): array {
		return \CommonsBooking\Repository\Restriction::get(
			...
			true,
			null,
			array( 'publish', 'confirmed', 'unconfirmed' )
		);
	}

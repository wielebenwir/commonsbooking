...
class Booking extends Timeframe {
	...
	public function __construct() {
		...
		// TODO: check why this generates the message 4 times
		//add_action('admin_notices', array ( $this, 'BookingAdminNotice') );
	...
	/**
	 * Display permanent Admin notice on admin edit page for post type booking
	 *
	 * @return void
	 */
	public function BookingAdminNotice() {
			global $pagenow;
		
			$notice = commonsbooking_sanitizeHTML( __( 'Bookings should not be created, edited or canceled via this admin list. Click on preview to show booking details in frontend', 'commonsbooking' ) );

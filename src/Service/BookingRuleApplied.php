...
class BookingRuleApplied extends BookingRule {
	 ...
	 * @throws BookingRuleException
	 */
	public function setAppliesToWhat( bool $appliesToAll, array $appliedTerms = array() ): void {
	...
	private function getArgs(): array {
		$args = $this->appliedParams ?? array( null, null );

...
class UserRepository {
	...
	public static function getSelectableCBManagers() {
		return get_users( array( 'role__in' => self::getManagerRoles() ) );
	}

	public static function getManagerRoles(): array {
		return apply_filters( 'commonsbooking_manager_roles', array( Plugin::$CB_MANAGER_ID ) );
	}
	...
	public static function getAdminRoles(): array {
		return apply_filters( 'commonsbooking_admin_roles', array( 'administrator' ) );
	}

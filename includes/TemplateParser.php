 ...
 * @return mixed
 */
function commonsbooking_parse_template( string $template = '', $objects = array(), $sanitizeFunction = 'commonsbooking_sanitizeHTML' ) {
 ...
 * @return false|mixed
 */
function commonsbooking_parse_template_callback( $match, array $objects = array(), $sanitizeFunction = 'commonsbooking_sanitizeHTML' ) {

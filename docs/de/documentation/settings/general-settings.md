...
Unter Einstellungen -> CommonsBooking findest du den Reiter **Allgemein**
  ...
  * **Buchungsseite**
    * Wähle hier die Seite aus, die im [ User Widget ](../administration/widget) als Buchungsliste angezeigt werden soll, wenn die Nutzenden auf "Meine Buchungen" klicken. Das ist im Normalfall eine Seite, auf der der cb_bookings Shortcode eingebunden ist. 
  * **Buchungskommentar**

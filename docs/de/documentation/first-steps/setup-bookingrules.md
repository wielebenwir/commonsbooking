...
Es ist auch möglich in den [Einstellungen für die Zeitrahmen](booking-timeframes-manage)
die Nutzung nur bestimmten Nutzendengruppen zu erlauben oder in den Einstellungen für die [Artikel](create-item) ein Passwort für die Buchung festzulegen.
...
In den [Einstellungen für die Zeitrahmen](booking-timeframes-manage) ist es
...
betroffene Artikel / Standort zugewiesen ist immer ausgenommen. [Mehr zu manueller Vergabe von Berechtigungen.](../basics/permission-management)

...
Mithilfe eines [Filter Hooks](/documentation/administration/hooks-and-filter) kannst du eine bestimmte Rolle so einstellen,
...
einem [Filter](/documentation/administration/hooks-and-filter) (Dort findest du auch

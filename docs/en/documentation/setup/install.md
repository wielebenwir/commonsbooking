...
### Create locations, articles and time frames
  ...
  * You can then specify when an item should be available for lending at a specific location under the menu item ‘[**Timeframe**](../first-steps/booking-timeframes-manage)’.

You can find detailed information on this under [first steps](../first-steps/).

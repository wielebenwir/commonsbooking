...
The umbrella organization is called [Forum Freie Lastenräder](https://freieslastenrad.org) (FFL) and meets once a year at the location of an arbitrary initiative.

On the history of the plugin: A previous version was superseded by a redesign. Currently the plugin is available in major version 2. A previous version that was already widespread can be found under [cb-legacy](https://github.com/wielebenwir/cb).

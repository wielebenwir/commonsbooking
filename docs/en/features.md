...
###  Easy administration
  ...
  * Calendar integration: Automatic import of all relevant bookings into your digital calendar via [iCal format](/docs/en/documentation/manage-bookings/icalendar-feed.md).

...
abstract class RouteTest extends \WP_UnitTestCase
{
	const USER_ID = 1;
	...
	private function createLocation($title, $postStatus, $admins = []) {
	...
	private function createItem($title, $postStatus, $admins = []) {

<div class="inside">
    ...
    <div class="option-group" id="option-group-data-export">
      <details>
        <summary><?= cb_map\__('DATA_EXPORT', 'commons-booking-map', 'Data Export') ?></summary>
        <table class="text-left">
          <tr>
              <th>
    ...
    <div class="option-group" id="option-group-data-import">
      <details>
        <summary><?= cb_map\__('DATA_IMPORT', 'commons-booking-map', 'Data Import') ?></summary>
        <table class="text-left">
          <tr>
              <th>
    ...
    <div class="option-group" id="option-group-map-presentation">
      <details>
        <summary><?= cb_map\__('MAP_PRESENTATION', 'commons-booking-map', 'Map Presentation') ?></summary>
        <table class="text-left">
          <tr>
            <th>
    ...
    <div class="option-group" id="option-group-zoom">
      <details>
        <summary><?= cb_map\__('ZOOM', 'commons-booking-map', 'Zoom') ?></summary>
        <table class="text-left">
          <tr>
              <th>
    ...
    <div class="option-group" id="option-group-positioning-start">
      <details>
        <summary><?= cb_map\__('POSITIONING_START', 'commons-booking-map', 'Map Positioning (center) at Intialization') ?></summary>
        <table class="text-left">
          <tr>
              <th>
    ...
    <div class="option-group" id="option-group-adaptive-map-section">
      <details>
        <summary><?= cb_map\__('ADAPTIVE_MAP_SECTION', 'commons-booking-map', 'Adaptive Map Section') ?></summary>
        <table class="text-left">
          <tr>
              <th>
    ...
    <div class="option-group" id="option-group-popup">
      <details>
        <summary><?= cb_map\__('POPUP', 'commons-booking-map', 'Marker Popup') ?></summary>
        <table class="text-left">
          <tr>
              <th>
    ...
    <div class="option-group" id="option-group-custom-marker">
      <details>
        <summary><?= cb_map\__('CUSTOM_MARKER', 'commons-booking-map', 'Custom Marker') ?></summary>
        <table class="text-left">
          <tr>
            <th>
    ...
    <div class="option-group" id="option-group-cluster">
      <details>
        <summary><?= cb_map\__('CLUSTER', 'commons-booking-map', 'Cluster') ?></summary>
        <table class="text-left">
          <tr>
              <th>
      ...
      <details>
        <summary><?= cb_map\__('CUSTOM_CLUSTER_MARKER', 'commons-booking-map', 'Custom Cluster Marker') ?></summary>
    ...
    <div class="option-group" id="option-group-item-status-appearance">
      <details>
        <summary><?= cb_map\__('APPEARANCE_BY_ITEM_STATUS', 'commons-booking-map', 'Appearance by Item Status') ?></summary>
    ...
    <div class="option-group" id="option-group-item-status-appearance">
      <details>
        <summary><?= cb_map\__('CUSTOM_ITEM_DRAFT_MARKER', 'commons-booking-map', 'Custom Item Draft Marker') ?></summary>
        <table class="text-left">
          <tr>
            <th>
              <?= cb_map\__('IMAGE_FILE', 'commons-booking-map', 'image file') ?>:
    ...
    <div class="option-group" id="option-group-filter-users">
      <details>
        <summary><?= cb_map\__('FILTER_USERS', 'commons-booking-map', 'Filter for Users') ?></summary>
        <table class="text-left">
          <tr>
              <th>
    ...
    <div class="option-group" id="option-group-filter-presets">
      <details>
        <summary><?= cb_map\__('FILTER_PRESETS', 'commons-booking-map', 'Filter Presets') ?></summary>
        <table class="text-left">
          <tr>
            <th>
